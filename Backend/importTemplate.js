    ...
    "bom": {
      ...
      "categories": [
        ...
        },
        {
          ...
          "materials": [
            { "item": "3.1.1", "description": "Non-skid floor tile (20cm x 20cm) - *Basic Ceramic Tile*", "quantity": 158, "unit": "pcs", "cost": 12, "totalAmount": 1896 },
            { "item": "3.1.2", "description": "Toilet Wall Tile (20cm x 20cm) - *Basic Ceramic Tile*", "quantity": 473, "unit": "pcs", "cost": 12, "totalAmount": 5676 },
            { "item": "3.1.3", "description": "Tile Adhesive - *Economy Quality*", "quantity": 3, "unit": "bags", "cost": 200, "totalAmount": 600 },
            { "item": "3.1.4", "description": "Tile Grout - *Economy Quality*", "quantity": 12, "unit": "bags", "cost": 35, "totalAmount": 420 },
            { "item": "3.1.5", "description": "Cement Mortar - *Basic Cement*", "quantity": 3, "unit": "bags", "cost": 200, "totalAmount": 600 }
          ]
        },
        {
          "category": "Roofing",
          "materials": [
            ...
            { "item": "4.2.1", "description": "Pre-painted Metal Roof - *Thinner Gauge Metal*", "quantity": 20, "unit": "sheets", "cost": 1000, "totalAmount": 20000 },
            { "item": "4.2.2", "description": "Pre-painted Gutter - *Economy Gutter*", "quantity": 8, "unit": "pcs", "cost": 250, "totalAmount": 2000 },
            { "item": "4.2.3", "description": "End Flashing - *Economy Flashing*", "quantity": 8, "unit": "pcs", "cost": 200, "totalAmount": 1600 },
            { "item": "4.2.4", "description": "Tekscrew - *Economy Quality*", "quantity": 9, "unit": "kgs", "cost": 200, "totalAmount": 1800 },
            { "item": "4.2.5", "description": "Hipped Roll - *Economy Quality*", "quantity": 10, "unit": "pcs", "cost": 200, "totalAmount": 2000 }
          ]
        },
        {
          "category": "Doors and Windows",
          "materials": [
            { "item": "5.1.1", "description": "Solid Wooden Panel Door, Jamb and Accessories - *Economy Quality Wood*", "quantity": 1, "unit": "set", "cost": 4000, "totalAmount": 4000 },
            { "item": "5.1.2", "description": "Fabricated Flush Door, Jamb and Accessories - *Economy Quality Plywood*", "quantity": 5, "unit": "set", "cost": 2000, "totalAmount": 10000 },
            { "item": "5.1.3", "description": "Polyvinyl Chloride Door with Louver, Jamb and Accessories - *Economy Quality PVC*", "quantity": 1, "unit": "set", "cost": 1000, "totalAmount": 1000 },
            { "item": "5.1.4", "description": "Aluminum Sliding Door and Accessories - *Economy Quality Aluminum*", "quantity": 1, "unit": "set", "cost": 10000, "totalAmount": 10000 },
            { "item": "5.2.1", "description": "1.4m x 1.2m (H) Aluminum Sliding Window - *Economy Quality Aluminum*", "quantity": 1, "unit": "set", "cost": 8000, "totalAmount": 8000 },
            { "item": "5.2.2", "description": "1.5m x 0.5m (H) Aluminum Awning Window - *Economy Quality*", "quantity": 1, "unit": "set", "cost": 1000, "totalAmount": 1000 },
            { "item": "5.2.3", "description": "1.6m x 1.2m (H) Aluminum Sliding Window - *Economy Quality Aluminum*", "quantity": 6, "unit": "set", "cost": 9000, "totalAmount": 54000 },
            { "item": "5.2.4", "description": "0.5m x 0.5m (H) Aluminum Awning Window - *Economy Quality*", "quantity": 1, "unit": "set", "cost": 300, "totalAmount": 300 }
          ]
        },
        {
          "category": "Electrical",
